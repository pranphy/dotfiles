...
load_plugins({
    ...
    {"nvim-treesitter/nvim-treesitter", branch='main', lazy=false, build=':TSUpdate', dependencies={"nvim-treesitter/nvim-treesitter-textobjects"}},
    ...
    {"Saghen/blink.cmp", version="1.*", dependencies={"erooke/blink-cmp-latex"}},
    "folke/zen-mode.nvim",
    ...
    { dir = "~/repos/pamdex", lazy = false, cfg={path="plugin.pamdex"}},
    "norcalli/nvim-colorizer.lua",
    --{ "CopilotC-Nvim/CopilotChat.nvim", dependencies={"github/copilot.vim"}, build="make tiktoken"}, 
    --{"yetone/avante.nvim", dependencies={"nvim-lua/plenary.nvim", "MunifTanjim/nui.nvim"}},
    --"olimorris/codecompanion.nvim",
    "NickvanDyke/opencode.nvim",
    ---{"dmtrKovalenko/fff.nvim", build = "cargo build --release",}, 
